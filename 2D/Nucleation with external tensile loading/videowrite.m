...
for i= 1: 100
    ...
    load(['ElasticEnergy_ttime_', num2str(i*0.1004*2, '%6.4f'),'s.mat']);  
    load(['sumphiAplot2_ttime_', num2str(i*0.1004*2, '%6.4f'),'s.mat']);
    load(['VonMisesStress_ttime_', num2str(i*0.1004*2, '%6.4f'),'s.mat']);
