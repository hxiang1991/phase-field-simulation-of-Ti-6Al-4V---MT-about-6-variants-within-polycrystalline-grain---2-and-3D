function [tot_Cpq,hom_Cpq,het_Cpq,eigen,gomega,tot_Cpqrs,Spq] = greenmatrix_stiffnessmatrix_eigenstrain(grainBs,variants,phiB,ang,e0,nx,ny,kx,ky,c11,c12,c44,k_pl)
...
eigen= zeros(2,2,variants,grainBs);
            ...
            for jj= 1: 2
                for kk= 1: 2
                    for ll= 1: 2
                        ...
                        eigen(ii,jj,v,g)= eigen(ii,jj,v,g)+ rot(ii,kk,g)* rot(jj,ll,g)* e0(kk,ll,v);
